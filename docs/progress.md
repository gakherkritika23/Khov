...
| E1 | Search bar | 🟡 Partial | SB-01, SB-02 done; SB-03 (search→community page) next |
...
1. **SB-03** — search a community name in the search bar and land directly on its community page.
2. **E3** — Community page POM + spec (listing header, floorplan section, QMI section).
